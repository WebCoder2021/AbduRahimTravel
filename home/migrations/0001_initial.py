    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('convensere', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='home.convensere')),
            ],
        ),
        migrations.CreateModel(
            name='Reservation',
            fields=[
                ...
                ('wekkly_offres', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='home.weeklyoffers')),
            ],
        ),
        migrations.CreateModel(
            name='Region',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city_town', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='home.citytown')),
                ('region', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='home.region')),
                ('weekly_offres', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='home.weeklyoffers')),
            ],
        ),
    ]
